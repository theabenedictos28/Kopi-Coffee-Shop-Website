    ...
    <div class="container">
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="radio-group">
                <input type="radio" id="hot" name="category" value="Hot" required <?php if($category == 'Hot') echo 'checked'; ?>>
                <label for="hot">Hot</label>
                <input type="radio" id="cold" name="category" value="Cold" required <?php if($category == 'Cold') echo 'checked'; ?>>
                <label for="cold">Cold</label>
                <input type="radio" id="pastry" name="category" value="Pastry" required <?php if($category == 'Pastry') echo 'checked'; ?>>
                <label for="pastry">Pastry</label>
                <input type="radio" id="salad" name="category" value="Salad" required <?php if($category == 'Salad') echo 'checked'; ?>>
