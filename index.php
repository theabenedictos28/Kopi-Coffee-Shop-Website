            ...
            <div class="row">
                <div class="col-lg-6 mb-5">
                    <div class="row align-items-center">
                        <div class="col-sm-5">
                            <img class="img-fluid mb-3 mb-sm-0" src="img/freewifi.png" alt="">
                        </div>
                        <div class="col-sm-7">
                            <h4><i class="fa fa-chart-line service-icon"></i>Free Wifi</h4>
                            <p class="m-0">Enjoy seamless connectivity with our complimentary WiFi service! Stream, browse, and stay connected with ease while you're here.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mb-5">
                    <div class="row align-items-center">
                        <div class="col-sm-5">
                            <img class="img-fluid mb-3 mb-sm-0" src="img/music.png" alt="">
                        </div>
                        <div class="col-sm-7">
                            <h4><i class="fa fa-coffee service-icon"></i>Music</h4>
                            <p class="m-0">Experience the perfect ambiance with our curated selection of music! From soothing melodies to upbeat tunes, we've handpicked a playlist to complement your surroundings and elevate your experience. Sit back and relax. </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mb-5">
                    <div class="row align-items-center">
                        <div class="col-sm-5">
                            <img class="img-fluid mb-3 mb-sm-0" src="img/meetingspace.jpg" alt="">
                        </div>
                        <div class="col-sm-7">
                            <h4><i class="fa fa-award service-icon"></i>Meeting Space</h4>
                            <p class="m-0">Unlock productivity in our versatile meeting spaces! Designed to inspire collaboration and creativity, our meeting rooms offer the ideal setting for your next gathering. </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mb-5">
                    <div class="row align-items-center">
                        <div class="col-sm-5">
                            <img class="img-fluid mb-3 mb-sm-0" src="img/togo.jpg" alt="">
                        </div>
                        <div class="col-sm-7">
                            <h4><i class="fa fa-suitcase service-icon"></i>To-Go Orders</h4>
                            <p class="m-0">At our coffee shop, to-go orders are a game-changer, providing our customers with the ultimate convenience. With speedy service and hassle-free pick-up options, we make sure busy schedules never get in the way of enjoying their favorite brews on the move.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mb-5">
                    <div class="row align-items-center">
                        <div class="col-sm-5">
                            <img class="img-fluid mb-3 mb-sm-0" src="img/service.png" alt="">
                        </div>
                        <div class="col-sm-7">
                            <h4><i class="fa fa-award service-icon"></i>Fast Customer Service</h4>
                            <p class="m-0">At our coffee shop, customer service is our top priority, ensuring every interaction is swift and satisfying. With attentive staff and efficient systems in place, we guarantee a seamless experience that keeps our customers coming back for more. </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mb-5">
                    <div class="row align-items-center">
                        <div class="col-sm-5">
                            <img class="img-fluid mb-3 mb-sm-0" src="img/calendar.png" alt="">
                        </div>
                        <div class="col-sm-7">
                            <h4><i class="fa fa-suitcase service-icon"></i>Events</h4>
                            <p class="m-0">At our coffee shop, we pride ourselves on hosting unforgettable events that bring our community together. From live music nights to themed gatherings, we create vibrant spaces where people can connect over great coffee and good vibes, making memories that last a lifetime.</p>
                        </div>
                    </div>
                </div>
                 <div class="col-lg-6 mb-5">
                    <div class="row align-items-center">
                        <div class="col-sm-5">
                            <img class="img-fluid mb-3 mb-sm-0" src="img/c3.jpg" alt="">
                        </div>
                        <div class="col-sm-7">
                            <h4><i class="fa fa-suitcase service-icon"></i>Seating</h4>
                            <p class="m-0">At our coffee shop, seating isn't just about finding a spot, it's about crafting a cozy atmosphere where customers can unwind and recharge. With comfortable seating arrangements designed for both solo relaxation and group gatherings, we provide the perfect setting for enjoying our delicious brews and engaging in meaningful conversations.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mb-5">
                    <div class="row align-items-center">
                        <div class="col-sm-5">
                            <img class="img-fluid mb-3 mb-sm-0" src="img/pin.png" alt="">
                        </div>
                        <div class="col-sm-7">
                            <h4><i class="fa fa-award service-icon"></i>Merchandise</h4>
                            <p class="m-0">At our coffee shop, our merchandise isn't just an afterthought, it's a reflection of our commitment to quality and style. From sleek mugs to artisanal beans, we curate a selection of merchandise that allows our customers to bring a piece of our coffee culture home with them, ensuring their coffee experience extends far beyond our shop's walls. </p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid footer text-white mt-5 pt-5 px-0 position-relative overlay-top">
        <div class="row mx-0 pt-5 px-sm-3 px-lg-5 mt-4">
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <p class="m-0"><i class="fa fa-envelope mr-2"></i>kopi.business@gmail.com</p>
            </div>
            <div class="col-lg-3 col-md-6 mb-5">
